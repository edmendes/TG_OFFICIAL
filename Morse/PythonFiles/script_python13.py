...
def detecting_sidewalk(lateral_laser):
    ...
    if lateral_laser < 1.85:
        speed.linear.x = 1 
        speed.angular.z = -0.04

    elif lateral_laser > 2.2:
        speed.linear.x = 1 
        speed.angular.z = +0.04 
...
while not rospy.is_shutdown():
    ...
    detecting_sidewalk(lateral_laser)
