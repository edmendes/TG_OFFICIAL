...
while not rospy.is_shutdown():
    ...
    detecting_sidewalk(lateral_laser, lateral_laser_max, i1, i2, i3, 2) #the last statement indicates if is turning left - 0 or right - 1 and also keeping the movement
