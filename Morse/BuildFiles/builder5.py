...
table2 = PassiveObject('props/objects','SmallTable')
table2.setgraspable()
table2.translate(x=-35, y=35, z=-4.9)
table2.properties(Type = "table", Object = True, Graspable = True, Label = "TABLE")
...
table5 = PassiveObject('props/objects','SmallTable')
table5.setgraspable()
table5.translate(x=-118, y=22, z=-4.9)
table5.properties(Type = "table", Object = True, Graspable = True, Label = "TABLE")

table6 = PassiveObject('props/objects','SmallTable')
table6.setgraspable()
table6.translate(x=-106, y=-35, z=-4.9)
table6.properties(Type = "table", Object = True, Graspable = True, Label = "TABLE")

table7 = PassiveObject('props/objects','SmallTable')
table7.setgraspable()
table7.translate(x=-23, y=-23, z=-4.9)
table7.properties(Type = "table", Object = True, Graspable = True, Label = "TABLE")
